...
def hcs1():
    def hc_solver(filePath, count):
    	try:
    		...
    		t3 = len(t1) + len(t2) + len(t22) + len(t23) + len(t24) + len(t25) + len(t26) + len(t27)
...
p1 = multiprocessing.Process(target=hcs1)
p2 = multiprocessing.Process(target=hcs2)
p3 = multiprocessing.Process(target=hcs3)
